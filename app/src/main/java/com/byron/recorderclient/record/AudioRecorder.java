package com.byron.recorderclient.record;
...
public class AudioRecorder {
    ...
    public void startRecord(final RecordStreamListener listener) {
        ...
        Log.d("AudioRecorder", "===startRecordTest===" + audioRecord.getState());
        audioRecord.startRecording();

        ThreadPoolUtil.getInstance().getExecutor().submit(new Runnable() {
            @Override
            public void run() {
    ...
    private void writeDataTOFile(RecordStreamListener listener) {
        ...
        Log.i(TAG, "bufferSizeInBytes 大小: " + bufferSizeInBytes);
